...
class Task_detail extends Admin_Controller
{
    ...
    {
        $this->load->vars(array(
            'page_title' => '<strong>Assignment</strong> | Task Detail',
            'page_icon' => '<a class="btn btn-primary" href="' . site_url('assignment/task_detail/add') . '"> <i class="fa fa-plus"></i> Add</a>',
        ));
        ...
        $this->template
            ...
            ->set_js('controllers/assignment/task_detail/index')
            ->build('assignment/task_detail/index');
    }
    ...
    public function add($jenis_surat_pos)
    {
        ...
        $this->template
            ...
            ->set_js(assets_url('js/app/controller/assignment/task_detail/add'))
            ->build('assignment/task_detail/add');
    }
    ...
    public function update($id)
    {
        ...
        $this->template
            ...
            ->set_js(bower_url('angular-animate/angular-animate'))
            ->set_js(bower_url('angularjs-toaster/toaster'))
            ->set_js(assets_url('js/app/controller/assignment/task_detail/update'))
            ->build('assignment/task_detail/update');
    }
    ...
    public function delete($id)
    {
        ...
        $this->template
            ...
            ->set_js(bower_url('angular-animate/angular-animate'))
            ->set_js(bower_url('angularjs-toaster/toaster'))
            ->set_js(assets_url('js/app/controller/assignment/task_detail/delete'))
            ->build('assignment/task_detail/delete');
    }
    ...
    public function view($id)
    {
        ...
        $this->template
            ...
            ->set_js(bower_url('angular-animate/angular-animate'))
            ->set_js(bower_url('angularjs-toaster/toaster'))
            ->set_js(assets_url('js/app/controller/assignment/task_detail/view'))
            ->build('assignment/task_detail/view');
    }
