...
class Reminder extends Admin_Controller
{
    ...
    {
        $this->load->vars(array(
            'page_title' => '<strong>CRM</strong> | Reminder',
            'page_icon' => '<a class="btn btn-primary" href="' . site_url('crm/reminder/add') . '"> <i class="fa fa-plus"></i> Add</a>',
        ));
        ...
        $this->template
            ...
            ->set_js('controllers/crm/reminder/index')
            ->build('crm/reminder/index');
    }
    ...
    public function add($jenis_surat_pos)
    {
        ...
        $this->template
            ...
            ->set_js(assets_url('js/app/controller/crm/reminder/add'))
            ->build('crm/reminder/add');
    }
    ...
    public function update($id)
    {
        ...
        $this->template
            ...
            ->set_js(bower_url('angular-animate/angular-animate'))
            ->set_js(bower_url('angularjs-toaster/toaster'))
            ->set_js(assets_url('js/app/controller/crm/reminder/update'))
            ->build('crm/reminder/update');
    }
    ...
    public function delete($id)
    {
        ...
        $this->template
            ...
            ->set_js(bower_url('angular-animate/angular-animate'))
            ->set_js(bower_url('angularjs-toaster/toaster'))
            ->set_js(assets_url('js/app/controller/crm/reminder/delete'))
            ->build('crm/reminder/delete');
    }
    ...
    public function view($id)
    {
        ...
        $this->template
            ...
            ->set_js(bower_url('angular-animate/angular-animate'))
            ->set_js(bower_url('angularjs-toaster/toaster'))
            ->set_js(assets_url('js/app/controller/crm/reminder/view'))
            ->build('crm/reminder/view');
    }
