...
class Messaging extends Admin_Controller
{
    ...
    {
        $this->load->vars(array(
            'page_title' => '<strong>CRM</strong> | Messaging',
            'page_icon' => '<a class="btn btn-primary" href="' . site_url('crm/messaging/add') . '"> <i class="fa fa-plus"></i> Add</a>',
        ));
        ...
        $this->template
            ...
            ->set_js('controllers/crm/messaging/index')
            ->build('crm/messaging/index');
    }
    ...
    public function add($jenis_surat_pos)
    {
        ...
        $this->template
            ...
            ->set_js(assets_url('js/app/controller/crm/messaging/add'))
            ->build('crm/messaging/add');
    }
    ...
    public function update($id)
    {
        ...
        $this->template
            ...
            ->set_js(bower_url('angular-animate/angular-animate'))
            ->set_js(bower_url('angularjs-toaster/toaster'))
            ->set_js(assets_url('js/app/controller/crm/messaging/update'))
            ->build('crm/messaging/update');
    }
    ...
    public function delete($id)
    {
        ...
        $this->template
            ...
            ->set_js(bower_url('angular-animate/angular-animate'))
            ->set_js(bower_url('angularjs-toaster/toaster'))
            ->set_js(assets_url('js/app/controller/crm/messaging/delete'))
            ->build('crm/messaging/delete');
    }
    ...
    public function view($id)
    {
        ...
        $this->template
            ...
            ->set_js(bower_url('angular-animate/angular-animate'))
            ->set_js(bower_url('angularjs-toaster/toaster'))
            ->set_js(assets_url('js/app/controller/crm/messaging/view'))
            ->build('crm/messaging/view');
    }
