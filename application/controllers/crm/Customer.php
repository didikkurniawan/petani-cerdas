...
class Customer extends Admin_Controller
{
    ...
    {
        $this->load->vars(array(
            'page_title' => '<strong>CRM</strong> | Customer',
            'page_icon' => '<a class="btn btn-primary" href="' . site_url('crm/customer/add') . '"> <i class="fa fa-plus"></i> Add</a>',
        ));
        ...
        $this->template
            ...
            ->set_js('controllers/crm/customer/index')
            ->build('crm/customer/index');
    }
    ...
    public function add($jenis_surat_pos)
    {
        ...
        $this->template
            ...
            ->set_js(assets_url('js/app/controller/crm/customer/add'))
            ->build('crm/customer/add');
    }
    ...
    public function update($id)
    {
        ...
        $this->template
            ...
            ->set_js(bower_url('angular-animate/angular-animate'))
            ->set_js(bower_url('angularjs-toaster/toaster'))
            ->set_js(assets_url('js/app/controller/crm/customer/update'))
            ->build('crm/customer/update');
    }
    ...
    public function delete($id)
    {
        ...
        $this->template
            ...
            ->set_js(bower_url('angular-animate/angular-animate'))
            ->set_js(bower_url('angularjs-toaster/toaster'))
            ->set_js(assets_url('js/app/controller/crm/customer/delete'))
            ->build('crm/customer/delete');
    }
    ...
    public function view($id)
    {
        ...
        $this->template
            ...
            ->set_js(bower_url('angular-animate/angular-animate'))
            ->set_js(bower_url('angularjs-toaster/toaster'))
            ->set_js(assets_url('js/app/controller/crm/customer/view'))
            ->build('crm/customer/view');
    }
