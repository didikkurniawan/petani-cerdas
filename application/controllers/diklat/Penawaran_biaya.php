...
class Penawaran_biaya extends Admin_Controller
{
    ...
    public function index()
    {
        $this->load->vars(array(
            ...
            'page_icon' => "
                <a href='" . site_url('diklat/penawaran_biaya/add') . "' class='btn btn-primary' > <i class='fa fa-plus'></i> Tambah </a>
            "
        ));

        $this->template

            ->set_js('controllers/diklat/penawaran_biaya/index')
            ->build('diklat/penawaran_biaya/index');
    }
    ...
    public function add()
    {
        ...
        $this->template
            ...
            ->set_js('controllers/diklat/penawaran_biaya/add')
            ->build('diklat/penawaran_biaya/add');
    }
    ...
    public function update($id)
    {
        ...
        $date['detail_diklat'] = $this->diklat_model->view_detail($id);
        $this->template

            ->set_js('controllers/diklat/penawaran_biaya/update')
            ->build('diklat/penawaran_biaya/update',$date);
    }
    ...
    public function view($id)
    {
        ...
        $this->template
            ...
            ->set_js('controllers/diklat/penawaran_biaya/view')
            ->build('diklat/penawaran_biaya/view',$date);
    }
    ...
    public function delete($id)
    {
        ...
        $this->template
            ...
            ->set_js('controllers/diklat/penawaran_biaya/delete')
            ->build('diklat/penawaran_biaya/delete',$date);
    }
