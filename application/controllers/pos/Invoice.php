...
class Invoice extends Admin_Controller
{
    ...
    {
        $this->load->vars(array(
            'page_title' => '<strong>POS</strong> | Invoice',
            'page_icon' => '<a class="btn btn-primary" href="' . site_url('pos/invoice/add') . '"> <i class="fa fa-plus"></i> Add</a>',
        ));
        ...
        $this->template
            ...
            ->set_js('controllers/pos/invoice/index')
            ->build('pos/invoice/index');
    }
    ...
    public function add($jenis_surat_pos)
    {
        ...
        $this->template
            ...
            ->set_js(assets_url('js/app/controller/pos/invoice/add'))
            ->build('pos/invoice/add');
    }
    ...
    public function update($id)
    {
        ...
        $this->template
            ...
            ->set_js(bower_url('angular-animate/angular-animate'))
            ->set_js(bower_url('angularjs-toaster/toaster'))
            ->set_js(assets_url('js/app/controller/pos/invoice/update'))
            ->build('pos/invoice/update');
    }
    ...
    public function delete($id)
    {
        ...
        $this->template
            ...
            ->set_js(bower_url('angular-animate/angular-animate'))
            ->set_js(bower_url('angularjs-toaster/toaster'))
            ->set_js(assets_url('js/app/controller/pos/invoice/delete'))
            ->build('pos/invoice/delete');
    }
    ...
    public function view($id)
    {
        ...
        $this->template
            ...
            ->set_js(bower_url('angular-animate/angular-animate'))
            ->set_js(bower_url('angularjs-toaster/toaster'))
            ->set_js(assets_url('js/app/controller/pos/invoice/view'))
            ->build('pos/invoice/view');
    }
