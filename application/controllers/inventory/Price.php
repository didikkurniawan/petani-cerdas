...
class Price extends Admin_Controller
{
    ...
    {
        $this->load->vars(array(
            'page_title' => '<strong>Inventory</strong> | Price',
            'page_icon' => '<a class="btn btn-primary" href="' . site_url('inventory/price/add') . '"> <i class="fa fa-plus"></i> Add</a>',
        ));
        ...
        $this->template
            ...
            ->set_js('controllers/inventory/price/index')
            ->build('inventory/price/index');
    }
    ...
    public function add($jenis_surat_pos)
    {
        ...
        $this->template
            ...
            ->set_js(assets_url('js/app/controller/inventory/price/add'))
            ->build('inventory/price/add');
    }
    ...
    public function update($id)
    {
        ...
        $this->template
            ...
            ->set_js(bower_url('angular-animate/angular-animate'))
            ->set_js(bower_url('angularjs-toaster/toaster'))
            ->set_js(assets_url('js/app/controller/inventory/price/update'))
            ->build('inventory/price/update');
    }
    ...
    public function delete($id)
    {
        ...
        $this->template
            ...
            ->set_js(bower_url('angular-animate/angular-animate'))
            ->set_js(bower_url('angularjs-toaster/toaster'))
            ->set_js(assets_url('js/app/controller/inventory/price/delete'))
            ->build('inventory/price/delete');
    }
    ...
    public function view($id)
    {
        ...
        $this->template
            ...
            ->set_js(bower_url('angular-animate/angular-animate'))
            ->set_js(bower_url('angularjs-toaster/toaster'))
            ->set_js(assets_url('js/app/controller/inventory/price/view'))
            ->build('inventory/price/view');
    }
