...
class Product_category extends Admin_Controller
{
    ...
    {
        $this->load->vars(array(
            'page_title' => '<strong>Inventory</strong> | Product Category',
            'page_icon' => '<a class="btn btn-primary" href="' . site_url('inventory/product_category/add') . '"> <i class="fa fa-plus"></i> Add</a>',
        ));
        ...
        $this->template
            ...
            ->set_js('controllers/inventory/product_category/index')
            ->build('inventory/product_category/index');
    }
    ...
    public function add($jenis_surat_pos)
    {
        ...
        $this->template
            ...
            ->set_js(assets_url('js/app/controller/inventory/product_category/add'))
            ->build('inventory/product_category/add');
    }
    ...
    public function update($id)
    {
        ...
        $this->template
            ...
            ->set_js(bower_url('angular-animate/angular-animate'))
            ->set_js(bower_url('angularjs-toaster/toaster'))
            ->set_js(assets_url('js/app/controller/inventory/product_category/update'))
            ->build('inventory/product_category/update');
    }
    ...
    public function delete($id)
    {
        ...
        $this->template
            ...
            ->set_js(bower_url('angular-animate/angular-animate'))
            ->set_js(bower_url('angularjs-toaster/toaster'))
            ->set_js(assets_url('js/app/controller/inventory/product_category/delete'))
            ->build('inventory/product_category/delete');
    }
    ...
    public function view($id)
    {
        ...
        $this->template
            ...
            ->set_js(bower_url('angular-animate/angular-animate'))
            ->set_js(bower_url('angularjs-toaster/toaster'))
            ->set_js(assets_url('js/app/controller/inventory/product_category/view'))
            ->build('inventory/product_category/view');
    }
