...
class Sertifikat extends Admin_Controller
{
    ...
    public function draft()
    {
        $this->load->vars(array(
            'page_title' => '<strong>Sertifikat</strong> | Draft',
        ));

        $this->template
            ->set_js('controllers/sertifikat/draft')
            ->build('sertifikat/draft');
    }

    public function verifikasi()
    {
        $this->load->vars(array(
            'page_title' => '<strong>Sertifikat</strong> | Verifikasi',
        ));

        $this->template
            ->set_js('controllers/sertifikat/verifikasi')
            ->build('sertifikat/verifikasi');
    }

    public function index()
    {
        $this->load->vars(array(
            'page_title' => '<strong>Sertifikat</strong> | Log',
            'page_icon' => "
    ...
    {
        $this->load->vars(array(
            'page_title' => '<strong>Sertifikat</strong> | Buat',
        ));
