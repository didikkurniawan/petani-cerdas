 ...
 */
class Kalibrasi extends Admin_Controller
{
    ...
    public function index()
    {
        $this->load->vars(array(
            'page_title' => '<strong>Kalibrasi</strong> | Log',
            'page_icon' => "
    ...
    {
        $this->load->vars(array(
            'page_title' => '<strong>Kalibrasi</strong> | Verifikasi',
        ));

        $this->template

            ->set_js('controllers/kalibrasi/verifikasi')
            ->build('kalibrasi/verifikasi');
    }
