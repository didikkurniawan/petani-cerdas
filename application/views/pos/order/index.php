...
<div class="panel">
    <div class="panel-body no-padder">
        <table class="table table-hover table-striped" id="table-order">
            ...
            <tr>
                <td>
                    <strong><a href="<?php echo site_url('pos/order/view/1') ?>"
                               class="text-primary">ORD/IND/19328409</a></strong>
                </td>
                <td>
                    <?php echo date('Y-m-d H:i:s'); ?>
                </td>
                <td>
                    PT. Angin Ribut <br/> <strong>Type</strong>
                    <small>Outbound <i class="fa fa-arrow-up"></i></small>
                </td>
                <td>
                    15.000.000
                </td>
            ...
            <tr>
                <td>
                    <strong><a href="<?php echo site_url('pos/order/view/2') ?>"
                               class="text-primary">ORD/IND/19328410</a></strong>
                </td>
                <td>
                    <?php echo date('Y-m-d H:i:s'); ?>
                </td>
                <td>
                    PT. Sejahtera Bersama <br/> <strong>Type</strong>
                    <small>In Bound <i class="fa fa-arrow-down"></i></small>
                </td>
                <td>
                    3.000.000
                </td>
            ...
            <tr>
                <td>
                    <strong><a href="<?php echo site_url('pos/order/view/3') ?>"
                               class="text-primary">ORD/IND/19328411</a></strong>
                </td>
                <td>
                    <?php echo date('Y-m-d H:i:s'); ?>
                </td>
                <td>
                    PT. Maju Mundur <br/> <strong>Type</strong>
                    <small>Outbound <i class="fa fa-arrow-up"></i></small>
                </td>
                <td>
                    8.000.000
