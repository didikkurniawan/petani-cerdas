<form method="post" name="formAddWarga" ng-submit="vm.update()" novalidate>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" init-data="init.pendidikan" ng-model="vm.data.pendidikan">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <select class="form-control" init-data="init.pekerjaan" ng-model="vm.data.pekerjaan">
