                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <textarea cols="4" rows="2" class="form-control" name="alamat" id="alamat" required disabled><?php echo $data->alamat;?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <textarea cols="4" rows="2" class="form-control" name="alamat_invoice" id="alamat_invoice" required disabled><?php echo $data->alamat_invoice;?></textarea>
                            </div>
                        </div>
                    </div>
