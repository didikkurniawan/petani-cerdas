        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center">
                <div class="m-t-xxl m-b-xxl padder-v">
                    ...
                    <h3 class="text-muted m-t-xl l-h-1x">Angulr is a <span class="b-b b-2x">Bootstrap</span> based
                        web ui kits package, Using grunt and bower with Bootstrap and Angular, features <span
                            class="b-b b-2x">nested views &amp; routing</span> and <span class="b-b b-2x">lazy load</span>
                        for large project.</h3>
                </div>
                <p class="text-center m-b-xxl wrapper">
                    <a href="http://themeforest.net/item/angulr-bootstrap-admin-web-app-with-angularjs/8437259?ref=flatfull"
                       target="_blank"
            ...
            <div class="col-sm-6" data-ride="animated" data-animation="fadeInLeft" data-delay="300">
                <div class="m-t-xxl">
                    ...
                    <div class="m-b text-right">
                        <a href class="pull-right thumb-sm avatar"><img src="../html/img/a3.jpg" class="img-circle"
                                                                        alt="..."></a>
                    ...
                    <p>
                        <a href="http://themeforest.net/user/Flatfull/portfolio?ref=flatfull" target="_blank"
                           class="text-sm btn btn-lg btn-rounded btn-default m-sm">
                            ...
                            <span class="block clear m-t-xs text-left m-r m-l">Available on the <b
                                    class="text-lg block font-bold">App Store</b>
                </span>
                        </a>
                    </p>
                    <p>
                        <a href="index.html" target="_blank"
                           class="text-sm btn btn-lg btn-rounded btn-default m-sm">
                            ...
                            <span class="block clear m-t-xs text-left m-r m-l">Get it on <b
                                    class="text-lg block font-bold">Google Play</b>
                </span>
                        </a>
                    </p>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 m-b-xl">
                            <h4 class="font-thin l-h-2x text-white m-b-lg"><em>“Vestibulum ullamcorper sodales nisi
                                    ...
                                    sollicitudin venenatis ipsum ac feugiat. Vestibul ultricies neque, quis malesuada
                                    augue. Donec eleifend condimentum.”</em></h4>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3  m-b-xl">
                            <h4 class="font-thin l-h-2x text-white m-b-lg"><em>"Integer eleifend, nisl venenatis
                                    consequat iaculis Duis non malesuada est, quis congue nibh. Pellentesque et netus et
                                    malesuada fames ac turpis malesuada est, quis congue nibh. Pellentesque habitant
                                    morbi tristique senectus et netus et malesuada fames ac turpis egestas.”</em></h4>
