        ...
        <div class="col-lg-6">
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-lg-9">
                <input type="text" class="form-control" v-model="vm.namaPerusahaan" name="nama-perusahaan" required/>
              </div>
            </div>
          </div>
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-lg-9">
                <input type="text" class="form-control" v-model="vm.contactPerson" name="contact-person" required/>
              </div>
            </div>
          </div>
          <div class="form-group">
